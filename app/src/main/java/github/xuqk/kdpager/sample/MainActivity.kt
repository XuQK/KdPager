            ...
            Column {
                Row(modifier = Modifier.height(40.dp)) {
                    ...
                    Box(
                        ...
                        BasicText(text = "Add Tab", style = TextStyle(color = Color.White))
                    }
                    Box(
                        modifier = Modifier
                            .weight(1f)
                ...
                if (show) {
                    KdPager(
                        ...
                        Column(
                            ...
                            BasicText(text = "TabIndex: $page", style = TextStyle(fontSize = 30.sp))
                            BasicText(text = SAMPLE_TEXT)
                        }
                    }
                } else {
                    Box(
